...
The design decision, of not use anything besides the time and user id, was made
...
Different time intervals were also tested in order to understand which can help
