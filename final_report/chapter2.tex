...
In the figure \ref{fig:ts_error_selection} the author tries to make easier to
...
A related approach is to use the percentage which a given model is better than
the baseline method. Can be defined as:
\\
