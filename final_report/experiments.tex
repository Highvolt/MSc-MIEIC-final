...
\label{fig:vol_safari_12h_wo_clustering} \end{center} \end{figure}
...
\label{fig:vol_safari_12h_wo_clustering_safari_4} \end{center} \end{figure}
...
\label{fig:vol_safari_12h_w_clustering} \end{center} \end{figure}
...
\label{fig:vol_safari_12h_w_clustering_safari_4} \end{center} \end{figure}
